...
<div className='details'>
      <div className='left-side'><img src="img/contact.png" /> <div><h3 style={sty}>Contact Me:</h3><p style={sty}>xxxxxxxxxxx</p></div></div>
      <div className='left-side'><img src="img/gmail.png" /> <div><h3 style={sty}>Email Me:</h3><p style={sty}>xxxxxxxxxxx</p></div></div>
