...
export function Intro({sty,data}) {
  ...
  return (
    <div  className='sec_bar'>
       ...
       <div className="intro-btn"> <a className='button' href='mailto:murugesansuryamsp@gmail.com' target='_blank'><p className='btn_name'>{data?.[0].store?.[0].Intro.intro_btn}</p> <SendIcon /></a>
